...
class HalfLinear(torch.nn.Linear):
    def __init__(
        ...
        # Initialize the parent class with float16 dtype
        super().__init__(in_features, out_features, bias, dtype=torch.float16)
        # Disable gradients for this layer as suggested
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        return output_half.to(input_dtype)
...
class HalfBigNet(torch.nn.Module):
    ...
    def __init__(self):
        ...
        # TODO: Implement me (feel free to copy and reuse code from bignet.py)
        #raise NotImplementedError()
        # Build the model using HalfLinear layers but keep LayerNorm in full precision
        self.model = torch.nn.Sequential(
